...
if __name__ == '__main__':
    ...
    tweet_tokens = preprocess.tokenise_tweets(tweets, stopwords="most")
    tweets_trump, targets_trump, labels_trump, ids_trump = reader.readTweetsOfficial("../data/downloaded_Donald_Trump.txt", "utf-8", 1)
    tweet_tokens_trump = preprocess.tokenise_tweets(tweets_trump, stopwords="most")

    tweets_unlabelled = reader.readTweets("../data/additionalTweetsStanceDetection.json")
    tweet_tokens_unlabelled = preprocess.tokenise_tweets(tweets_unlabelled, stopwords="most")
